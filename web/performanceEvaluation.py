...
def performanceEvaluation(xTest,yTest,model):
    ...
    if len(matrix) == 1:
      matrix_str1_1 = str(matrix[0][0])
      matrix_str1_2 = " "
      matrix_str2_1 = " "
      matrix_str2_2 = " "
      #print("\t\t\t\t", matrix[0])
    else:
      #matrix_str = str(matrix[0]) + "\n" + str(matrix[1])
      #print("\t\t\t\t", matrix[0], "\n\t\t\t\t", matrix[1])
      matrix_str1_1 = str(matrix[0][0])
      matrix_str1_2 = str(matrix[0][1])
      matrix_str2_1 = str(matrix[1][0])
      matrix_str2_2 = str(matrix[1][1])
    return accuracy, precision, recall, f1, kappa, auc, matrix_str1_1,matrix_str1_2, matrix_str2_1,matrix_str2_2
...
def performanceEvaluationForEnsemble(xTest,yTest,model):
    ...
    matrix = confusion_matrix(yTest, yhat_classes)
    #print("\tmatrix:\n\tPredictive Values(positive, negative)\n\tActual Values(positive, \n\t\t\tnegative)"),
    matrix_str1_1 = matrix[0][0]
    matrix_str1_2 = matrix[0][1]
    matrix_str2_1 = matrix[1][0]
    matrix_str2_2 = matrix[1][1]
    return accuracy, precision, recall, f1, kappa, auc, matrix_str1_1,matrix_str1_2,matrix_str2_1,matrix_str2_2
