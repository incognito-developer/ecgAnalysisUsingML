...
def model4_debugresult():
    if request.method == 'POST':
        ...
        if data.shape[1] !=187:
            accuracy, precision, recall, f1, kappa = 0, 0, 0, 0, 0
            auc, matrix_str1,matrix_str2 = "", "",""
            accuracy, precision, recall, f1, kappa, auc, matrix_str1,matrix_str2 =main(data, file2, model1,True, True,True)
            ...
            accuracy, precision, recall, f1, kappa = 0, 0, 0, 0, 0
            auc, matrix_str1,matrix_str2 = "", "",""
            accuracy, precision, recall, f1, kappa, auc, matrix_str=main(data,file2,model1,True,False,True)
            return render_template('model4_debugresult.html', accuracy=accuracy, precision=precision, recall=recall, f1=f1, kappa=kappa, auc=auc, matrix_str1=matrix_str1,matrix_str2=matrix_str2)        
